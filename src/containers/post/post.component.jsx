...
const Post = (props) => {
  ...
  return (
    <li className="rounded border-4 border-orange-600 mt-2">
      ...
      <div className="flex justify-center">
        <div className="bg-gray-300 hover:bg-gray-400 w-20 h-10 rounded-l-lg border-r-2 border-gray-600">
          {props.optionAName}: {props.optionA}
        </div>
        <div className="bg-gray-300 hover:bg-gray-400 w-20 h-10 rounded-r-lg">
          {props.optionBName}: {props.optionB}
        </div>
      </div>
    </li>
  );
